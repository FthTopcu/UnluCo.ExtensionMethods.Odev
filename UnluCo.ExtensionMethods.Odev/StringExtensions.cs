...
namespace UnluCo.ExtensionMethods.Odev
{
    ...
    public static class StringExtensions
    {
        ...
        public static void isUpper(string str, bool isUppercase)
        {
            valids.Add(str.Any(Char.IsUpper) == isUppercase);
        }
        public static void isLower(string str, bool isLowercase)
        {
            valids.Add(str.Any(Char.IsLower) == isLowercase);
        }
        public static void isDigit(string str, bool isdigit)
        {
            valids.Add(str.Any(Char.IsDigit) == isdigit);
        }
        public static void isSymbol(string str, bool _isSymbol)
        {
            valids.Add(str.All(Char.IsLetterOrDigit) == _isSymbol);
        }
        public static void isLenghtValid(string str, bool _isLenghtValid)
        {
